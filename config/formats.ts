...
export const Formats: FormatList = [
	...
	{
		name: "[Gen 9] Weedmons",
		desc: `Weedmons is being used as a husk to grow my new empire muhahaha`,
		mod: 'weedmons',
		...
		'Assist', 'Baton Pass', 'Last Respects', 'Shed Tail', 'Sticky Web', 'Diancite', 'Mawilite', 'Heavy Duty Boots', 'Choice Specs', 'Choice Scarf', 
		...
		unbanlist: ['Wishiwashi', 'Mawile', 'Togepi', 'Togetic', 'Tarountula', 'Spidops', 'Pyukumuku', 'Cursola', 'Scatterbug', 'Spewpa', 'Vivillon', 'Bunnelby', 'Diggersby', 'Obstagoon', 
		...
		'Decidueye-Hisui', 'Ursaluna-Bloodmoon', 'Articuno-Galar', 'Audino-Mega', 'Petilil', 'Lilligant-Hisui',
		],
		onValidateTeam(team, format) {
            /**@type {{[k: string]: true}}*/
            let speciesTable = {};
            let allowedTiers = ['Weedmons OU', 'Weedmons NFE', 'Weedmons LC']; //Weedmons Uber exists but not playable
            for (const set of team) {
                let template = this.dex.species.get(set.species);
                ...
                if (!allowedTiers.includes(template.tier)) {
                    return [set.species + ' is not legal in Weedmons OU.'];
                }
            }
        },
	},
	...
	},
	{
		...
		banlist: [
			...
			'Leechmonner', 'Iron Crest', 'Odonata', 'Hebicikuga', 'Devestial', 'Lundicare',
		],
		onValidateTeam(team, format) {
			/**@type {{[k: string]: true}}*/
			let speciesTable = {};
	...
	},
	{
		...
		teambuilderFormat: "National Dex",
		ruleset: ['Standard NatDex', 'OHKO Clause', 'Evasion Moves Clause', 'Sleep Clause Mod', 'Data Mod', 'Mega Data Mod', 'Species Clause', 'Mega Rayquaza Clause', 'Big Button Rule', 'MILF Rule', 'Ohmyrod Rule', 'Serious Rule', 'Mario Kart Wii Clause', 'Spooky Secret Clause'],
		...
		'Absolite', 'Houndoominite', 'Red Orb', 'Blue Orb', 'Fish', 'Diamond Hand', 'Hoenn', 'Copen'],
  ...
  //	{
	...
	},
	{
		...
		banlist: ['Uber', 'Power Construct', 'Berserk Gene', 'Moody',
					...
					'Bright Powder', 'Lax Incense', 'King\'s Rock', 'Razor Fang', 'Shed Tail'],
